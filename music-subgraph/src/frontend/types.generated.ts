...
export type AggregationResultFromMusicSubgraph = {
  __typename?: 'AggregationResultFromMusicSubgraph';
...
export type Album = {
  ...
  artist: Artist;
  artist_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  title: Scalars['String']['output'];
  tracks: Array<Track>;
  tracks_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
};
...
export type Artist = {
  __typename?: 'Artist';
  albums: Array<Album>;
  albums_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
...
export type Customer = {
  ...
  employee_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  fax?: Maybe<Scalars['String']['output']>;
  firstName: Scalars['String']['output'];
  invoices: Array<Invoice>;
  invoices_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
...
export type Employee = {
  ...
  customers_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  email?: Maybe<Scalars['String']['output']>;
  employee?: Maybe<Employee>;
  employeeId: Scalars['ID']['output'];
  employee_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  employees: Array<Employee>;
  employees_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  fax?: Maybe<Scalars['String']['output']>;
  firstName: Scalars['String']['output'];
...
export type Invoice = {
  ...
  customer: Customer;
  customer_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  invoiceDate: Scalars['ISOString']['output'];
  invoiceId: Scalars['ID']['output'];
  invoiceLines: Array<InvoiceLine>;
  invoiceLines_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
...
export type InvoiceLine = {
  ...
  invoice_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  quantity: Scalars['Float']['output'];
  track: Track;
  track_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
...
export type Query = {
  ...
  artists_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  ...
  genres_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  ...
  mediaTypes_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  /** Get a single Playlist. */
  playlist?: Maybe<Playlist>;
  /** Get multiple Playlists. */
  playlists?: Maybe<Array<Maybe<Playlist>>>;
  /** Get aggregated data for Playlists. */
  playlists_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  /** Get a single Track. */
  track?: Maybe<Track>;
  /** Get multiple Tracks. */
...
export type Track = {
  __typename?: 'Track';
  album?: Maybe<Album>;
  album_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  bytes?: Maybe<Scalars['Float']['output']>;
  composer?: Maybe<Scalars['String']['output']>;
  genre?: Maybe<Genre>;
  genre_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  invoiceLines: Array<InvoiceLine>;
  invoiceLines_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
  mediaType: MediaType;
  mediaType_aggregate?: Maybe<AggregationResultFromMusicSubgraph>;
...
export type _Entity = Album | Artist | Customer | Employee | Genre | Invoice | InvoiceLine | MediaType | Playlist | Track;
